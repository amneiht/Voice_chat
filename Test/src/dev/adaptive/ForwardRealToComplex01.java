...
public class ForwardRealToComplex01 {
	...
	public static void transform(double[] data, double[] realOut, double[] imagOut, double[] angleOut,
			double[] magnitude, int zero, double lowF, double highF) {
		...
		for (int i = 0; i < dataLen; i++) {
			...
			magnitude[i] = (Math.sqrt(real * real + imag * imag)) / dataLen;
			...
			if (imag == 0.0 && real == 0.0) {
				...
				ang = Math.atan(imag / real) * 180.0 / pi;
			}
